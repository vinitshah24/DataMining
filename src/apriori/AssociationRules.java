...
public class AssociationRules {
    ...
    public static void main(String args[]) throws IOException {
        ...
        AssociationRules a = new AssociationRules();
        ...
        for (int i = 0; i < finalFrequentItemSet.size(); i++) {
            ...
            if (wordCountInString == 2) /* for FrequentItemSet = 2 */ {
                ...
                if (confidence >= minimumConfidence) {
                    System.out.println(words[0] + " -> " + words[1] + " = Confidence = " + confidence * 100 +
                            " and Support = " + (int) value + "");
                ...
                itemCount++;
                if (confidence >= minimumConfidence) {
                    System.out.println(words[1] + " -> " + words[0] + " = Confidence = " + confidence * 100 +
                            " and Support = " + (int) value + "");
                ...
                for (int a = 0; a < wordCountInString - 1; a++) {
                    ...
                    if (confidence >= minimumConfidence) {
                        System.out.println(str + " -> " + str1 + " = Confidence = " + confidence * 100 +
                                " and Support = " + (int) value + "");
                    }
                    if (confidence1 >= minimumConfidence) {
                        System.out.println(st + " -> " + str + " = Confidence = " + confidence1 * 100 +
                                " and Support = " + (int) value + "");
                    }
                    str1 = "";
                }
